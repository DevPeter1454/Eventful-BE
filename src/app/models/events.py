...
class Event(Base):
    ...
    about: Mapped[str] = mapped_column(String(63206))
    location: Mapped[str | None] = mapped_column(String(100), default=None)

    agenda: Mapped[list[str] | None] = mapped_column(String, default=None)
    faqs: Mapped[list[str] | None] = mapped_column(String, default=None)
